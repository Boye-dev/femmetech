...
const ResetPasswordPatient = () => {
    ...
    const { resetPasswordHandleSubmit, resetPasswordWatch } = useSignupContext();
    const { newPassword, confirmPassword } = resetPasswordWatch();
    ...
    <>
        ...
        >
            ...
            >
                ...
                {activeStep === 1 ? <ResetPasswordPatientStep2 setting={message} /> : ""}
                <LoadingButton
                    fullWidth
                    size="small"
                    loading={isLoading}
