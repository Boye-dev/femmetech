  ...
  return (
    ...
    >
      ...
      >
        ...
        <Box
          sx={{ display: {xs: "none", md: "flex"}, justifyContent: "space-around", width: "50%" }}
        >
        ...
        <Box
          sx={{ display: {xs: "none", md: "flex"}, justifyContent: "space-around", width: "30%" }}
        >
        ...
        <Fragment >
            ...
            >
              <MenuIcon sx={{color: "black", padding: "7px", borderRadius: "10px", border: "2px solid black"}}/>
            </Button>
            <SwipeableDrawer
                ...
                <Box sx={{ width: '100%', fontSize: "20px", }} >
                    <List component="nav" aria-label="main mailbox folders">
                      {["Home", "Dashboard", "Patients", "About Us", "Contact"].map(
                        (item) => {
                          return (
                            <Link style={{marginBottom: "20px", textDecoration: "none", color: "inherit"}} to={"/"}>
                              <ListItemButton
                              ...
                              >
                                  ...
                                  <Typography
                                    color="text.primary"
                                    variant="caption"
                                    sx={{ fontWeight: 500, fontSize: "30px", cursor: "pointer" }}
                                  >
                                    {item}
                                  </Typography>
                              </ListItemButton>
                    ...
                    >
                      <Button sx={{width: "100%", border: "1px solid", borderRadius: "50px",}} startIcon={<Person />}>Login</Button>
                    </ListItemButton>
                    <ListItemButton
                        sx={{ borderRadius: "6px" }}
                    >
